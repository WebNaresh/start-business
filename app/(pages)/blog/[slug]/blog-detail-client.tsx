            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button 
                  ...
                  className="p-2 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-gray-700 transition-colors"
                  title="Copy Link"
                >
                 ...
                 !blogPost.featuredImage.includes('via.placeholder') ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50">
                    <div className="text-center text-gray-400">
                      ...
                      <p className="text-sm mt-2">Use the admin panel to add an S3 image</p>
                    </div>
                  </div>
                )}
              </div>
