      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-sm font-bold text-slate-800 mb-0.5">Key Features</h3>
            ...
            {/* Ideal For Card */}
            <div className="relative group">
              <div className="bg-white rounded-2xl p-6 lg:p-8 border-2 border-slate-200 shadow-md hover:shadow-lg transition-all duration-300 relative overflow-hidden">
                {/* Card Background Pattern */}
                <div className="absolute inset-0 opacity-5">
                  <div className="absolute top-0 right-0 w-24 h-24 bg-blue-500 rounded-full -mr-12 -mt-12"></div>
                  <div className="absolute bottom-0 left-0 w-20 h-20 bg-blue-400 rounded-full -ml-10 -mb-10"></div>
                ...
                <div className="relative z-10">
                  {/* Card Header */}
                  <div className="flex items-center mb-6">
                    <div className="bg-blue-50 w-12 h-12 rounded-xl flex items-center justify-center mr-3 group-hover:scale-105 transition-transform duration-300">
                      <Users className="w-6 h-6 text-blue-600" />
                    </div>
                    <div>
                      <h3 className="text-sm font-bold text-slate-800 mb-0.5">Perfect For</h3>
                    ...
                    {service.idealFor?.map((item: string, index: number) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <ArrowRight className="w-3 h-3 text-slate-400 group-hover/item:text-blue-600 group-hover/item:translate-x-1 transition-all duration-300" />
                        </div>
                      )
                    }) || []}
                  </div>
