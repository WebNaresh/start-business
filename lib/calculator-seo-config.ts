...
export const calculatorSEOConfigs: Record<string, CalculatorSEOConfig> = {
    'ppf-calculator': {
        ...
        metaTitle: 'PPF Calculator Online - Calculate PPF Maturity Amount & Interest | StartBusiness',
        ...
        metaDescription: 'Free PPF Calculator to calculate Public Provident Fund maturity amount, interest rate, and returns. Plan your 15-year PPF investment with accurate calculations. Try now!',
        keywords: [
            'ppf calculator',
