  ...
  return (
    <AnimatePresence>
      <motion.a
        ...
        className="fixed left-6 z-[8999] flex items-center gap-2 px-4 h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#22c55e] transition-all duration-200 hover:scale-105 active:scale-95"
      ...
      >
        ...
        <span className="font-medium text-sm hidden sm:inline">Enquire Now</span>
      </motion.a>
    </AnimatePresence>
  )
}
