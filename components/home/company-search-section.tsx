        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative mb-10">
            <div className="relative group">
              <Search className={`absolute left-5 top-1/2 transform -translate-y-1/2 w-5 h-5 transition-all duration-200 z-20 pointer-events-none ${
              ...
              <Input
                ...
                className={`pl-14 pr-14 py-4 text-base border-2 rounded-xl bg-white shadow-md transition-all duration-200 ${
                  searchState.isTyping 
