            ...
            <div className="overflow-x-auto">
              <div className="min-w-full">
                <div
                  ...
                  style={{ gridTemplateColumns: `250px repeat(${selectedServiceData.length}, 1fr)` }}
                >
                  {/* Header Row */}
                    ...
                    >
                      <Card className={cn(
                        ...
                        <CardHeader className="text-center pb-4">
                          ...
                          <CardTitle className="text-lg">{service.shortTitle}</CardTitle>
        ...
        <div className="relative p-8 text-center">
          <div className="animate-in slide-in-from-top duration-500 delay-100">
            ...
            <p className="text-slate-600 mb-6 max-w-2xl mx-auto">
              Select 2-{maxComparisons} services to compare features, pricing, and benefits side by side.
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap mb-4">
              ...
              <div className="flex items-center gap-2">
                <div className={cn(
                  ...
                  selectedServices.length > 0 ? "bg-green-500" : "bg-slate-300"
                )}>
                </div>
            ...
            >
              <Card
                className={cn(
                  ...
                  isSelected && "ring-2 ring-blue-500 shadow-xl bg-gradient-to-br from-blue-50 to-indigo-50",
                  isDisabled && "opacity-50 cursor-not-allowed",
                  !isDisabled && !isSelected && "hover:border-slate-300 hover:bg-gradient-to-br hover:from-slate-50 hover:to-gray-50",
