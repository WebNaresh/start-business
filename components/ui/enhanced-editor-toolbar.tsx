        ...
        <TooltipTrigger asChild>
          <Button
            ...
            className={`h-8 w-8 p-0 ${
              button.active ? "bg-blue-600 text-white" : ""
            }`}
          >
            {button.icon}
          </Button>
      ...
      <div className="bg-white border border-slate-200 rounded-lg shadow-sm">
        ...
        <div className="flex items-center gap-1 p-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              <DropdownMenuItem
                onClick={() => onInsertBlock("header", { text: "", level: 1 })}
              >
                <Type className="w-4 h-4 mr-2 font-bold" />
                Heading 1
              </DropdownMenuItem>
              <DropdownMenuItem
                onClick={() => onInsertBlock("header", { text: "", level: 2 })}
              >
                <Type className="w-3.5 h-3.5 mr-2" />
                Heading 2
              </DropdownMenuItem>
              <DropdownMenuItem
                onClick={() => onInsertBlock("header", { text: "", level: 3 })}
              >
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <ul className="space-y-1 text-slate-600">
              <li>
                • <strong>Smart Paste:</strong> Copy formatted content from AI
                tools, Word, or web pages
              </li>
              <li>
                • <strong>Quick Format:</strong> Select text and use toolbar
                buttons for instant formatting
              </li>
              <li>
              ...
              <li>
                • <strong>Block Menu:</strong> Type "/" for traditional EditorJS
                block menu
              </li>
            </ul>
          </div>
